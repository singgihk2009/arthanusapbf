...
class RegulatoryProduct extends Model {
    protected $fillable=['source_id','nie','product_name_source','industry_name','dosage_form','strength','commodity_type','raw_packaging_text','raw_composition_text','raw_payload'];
    ...
    public function items(): BelongsToMany { return $this->belongsToMany(Item::class,'item_regulatory_products')->withPivot(['is_primary','notes'])->withTimestamps(); }
}

...
public function index(){return Inertia::render('Apps/Sales/Customers/Index');}
public function create(Request ){return Inertia::render('Apps/Sales/Customers/Form');}
public function store(Request ){return back()->with('success','Saved');}
public function show(string ){return Inertia::render('Apps/Sales/Customers/Show',['id'=>]);}
public function edit(string ){return Inertia::render('Apps/Sales/Customers/Form',['id'=>]);}

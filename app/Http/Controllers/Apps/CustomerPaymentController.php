...
public function index(){return Inertia::render('Apps/Sales/CustomerPayments/Index');}
public function create(Request ){return Inertia::render('Apps/Sales/CustomerPayments/Form');}
public function store(Request ){return back()->with('success','Saved');}
public function show(string ){return Inertia::render('Apps/Sales/CustomerPayments/Show',['id'=>]);}
public function edit(string ){return Inertia::render('Apps/Sales/CustomerPayments/Form',['id'=>]);}

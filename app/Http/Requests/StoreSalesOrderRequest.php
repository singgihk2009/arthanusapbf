...
'warehouse_id'=>['nullable','integer'],'document_date'=>['required','date'],'expected_delivery_date'=>['nullable','date','after_or_equal:document_date'],'price_list_id'=>['nullable','integer'],'notes'=>['nullable','string'],

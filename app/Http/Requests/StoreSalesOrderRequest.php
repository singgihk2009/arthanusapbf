...
'lines'=>['required','array','min:1'],'lines.*.id'=>['nullable','integer'],'lines.*.item_id'=>['required','integer'],'lines.*.batch_id'=>['nullable','integer'],'lines.*.uom_id'=>['required','integer'],'lines.*.facility_scheme_id'=>['nullable','integer'],'lines.*.qty_sold'=>['required','numeric','min:0.0001'],'lines.*.unit_price'=>['required','numeric','min:0'],'lines.*.discount_percent'=>['nullable','numeric','min:0','max:100'],'lines.*.tax_percent'=>['nullable','numeric','min:0','max:100'],'lines.*.notes'=>['nullable','string'],
]; }
}

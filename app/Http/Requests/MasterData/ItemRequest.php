...
class ItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'regulatory_product_id' => ['nullable', 'integer', 'exists:regulatory_products,id'],
            'manufacturer_name' => ['nullable', 'string'],
            'composition_text' => ['nullable', 'string'],
            'packing_text' => ['nullable', 'string'],
            'regulatory_class' => ['nullable', 'string', 'max:255'],

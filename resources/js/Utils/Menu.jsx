    ...
    const menuNavigation = [
        ...
        },
        {
            ...
            details: [
                ...
                { title: 'Master COA', href: '/apps/master-data/chart-of-accounts', icon: <IconListCheck size={20} strokeWidth={1.5} />, active: url.startsWith('/apps/master-data/chart-of-accounts'), permissions: true },
        ...
        },
        {
            ...
            details: [
                ...
                { title: 'Purchase Return', href: '/apps/procurement/purchase-returns', icon: <IconPackageExport size={20} strokeWidth={1.5} />, active: url.startsWith('/apps/procurement/purchase-returns'), permissions: true },

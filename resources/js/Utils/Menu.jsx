    ...
    const menuNavigation = [
        ...
        },
        {
            ...
            details: [
                ...
                { title: 'Fasilitas', href: route('apps.master-data.facility-schemes.index'), icon: <IconBuildingFactory2 size={20} strokeWidth={1.5} />, active: url.startsWith('/apps/master-data/facility-schemes'), permissions: true },
            ],
        },
        {
            title: 'PROCUREMENT',

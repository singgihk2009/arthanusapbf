...
export default function VendorTabs({vendor,currentTab,summary}){const [data,setData]=useState({}); const [loading,setLoading]=useState(false);
...
<div className='p-4'>{loading?<p className='text-sm text-gray-500'>Loading...</p>:<TabComp data={data} vendor={vendor} summary={summary} />}</div>
</div>}

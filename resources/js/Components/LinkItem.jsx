...
export default function LinkItem({href, icon, link, access, title, sidebarOpen, ...props}) {
    ...
    // styles links
    const sideOpen = 'flex items-center font-medium gap-x-3.5 px-4 py-3 hover:border-r-2 capitalize hover:cursor-pointer text-sm text-gray-700 hover:border-r-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:border-r-gray-50 dark:hover:text-gray-100';

...
export default function Index() {
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            const response = await window.axios.post(route('apps.master-data.regulatory-products.import.excel'), formData, {
        ...
        <>
            ...
            <div className="mb-5 grid gap-3 rounded-lg border border-gray-200 bg-white p-3 dark:border-gray-900 dark:bg-gray-950 md:grid-cols-12">
                ...
                <div className="flex items-end gap-2 md:col-span-8">
                    <a href={route('apps.master-data.regulatory-products.template.excel')} className="inline-flex items-center gap-1 rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-900">Download Template Import</a>

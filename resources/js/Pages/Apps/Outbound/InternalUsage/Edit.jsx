...
export default function Edit() {
    const { entry, lines, items, uoms, warehouses, batches, facilitySchemes, transactionCodes } = usePage().props;
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-900 dark:bg-gray-950">
                    <div className="mb-4 flex flex-wrap items-start justify-between gap-2">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">{viewOnly ? 'Dokumen POSTED hanya dapat dilihat.' : 'Perbarui dokumen dispatch inventory.'}</p>
                        </div>
                        <Link href={route('apps.outbound.internal-usage.print', entry.id)} className="rounded border border-amber-300 px-3 py-2 text-sm text-amber-700">Print</Link>
                    </div>

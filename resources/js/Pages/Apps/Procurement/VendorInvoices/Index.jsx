...
const resolvePaymentStatus = (status) => {
  ...
  if (key === 'partial_paid') return { label: 'Partial', className: 'border-amber-300 bg-amber-100 text-amber-700' };
